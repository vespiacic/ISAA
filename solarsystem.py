...
sim_start_date = "2021-02-27"  # simulating a solar system starting from this date
sim_duration = 31  #2 * 365                # (int) simulation duration in days
...
corpo=[[1, 2, 3, 4, -96, -144, -37, -121, -64,
     -234],['Mercurio', 'Venere: Akatsuki', 'Luna,L1,L2: 12 missioni', 'Marte: 11 missioni',
