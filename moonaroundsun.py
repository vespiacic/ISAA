...
v = vector(0.5,0,0)
E = sphere(pos=vector(3,0,0),color=color.blue,radius=.15,make_trail=True)
M = sphere(pos=E.pos+v,color=color.red,radius=0.1,make_trail=True)
S = sphere(pos=vector(0,0,0),color=color.yellow,radius=.2)
